...
bool namespace_1::Car::setSpeed(double speed)
{
	...
	void namespace_1::Car::print()
	{

		std::cout<<"name: Car"<<std::endl;
	}


	void namespace_1::Bike::print()
	{

		std::cout<<"name: Bike"<<std::endl;
	}

	

	void namespace_1::Vehicle::print()
	{

		std::cout<<"name: Vehicle"<<std::endl;
	}
	

	namespace_1::Vehicle::Vehicle()
	{
		;
	}
